;;; my-utils.el --- Miscellaneous utilities  -*- lexical-binding: t; -*-
...
(defvar my-utils-default-timestamp-format "%Y-%m-%d %H:%M:%S %z"
  "Default format for `my-utils-timestamp-format'.")

;;;###autoload
(cl-defun my-utils-get-file-name (&key (display-directory nil))
  "Return file name.
